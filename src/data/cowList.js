export default [
	...
	{
		name: 'Guzerat',
		description: 'The Guzerá or Guzerat is a Brazilian breed of domestic cattle. It derives from cross-breeding of Indian Kankrej cattle, imported to Brazil from 1870 onwards, with local taurine Crioulo cattle of European origin.The name is a Portuguese spelling of that of the western Indian state of Gujarat.<br/>' +
			'<br/>' +
			'The herd-book for the breed was started in 1938; in it, a dual-purpose (meat and dairy) line is distinguished from the beef type, and a polled variant is also distinguished. In 2010 there were approximately 92 000 head registered, constituting some 3.5% of the total number of indicine cattle in Brazil.<br/>' +
			'<br/>' +
	...
	{
		name: 'Hallikar',
		description: 'Hallikar (Kannada: ಹಳ್ಳಿಕಾರ್) is a breed of cattle native to the state of Karnataka, India. They are more common in the traditional Hallikar belt of Mysore, Mandya, Hassan and Tumkur districts of South Karnataka.<br/>' +
			'<br/>' +
